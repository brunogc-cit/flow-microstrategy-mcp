...
// Find prioritized reports that depend on this metric (live BFS traversal)
...
// Find source tables via live BFS traversal (Metric -> [Fact,Metric,Attribute,Column]* -> Table)
